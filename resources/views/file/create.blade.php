                                ...
                                <div class="md:grid md:grid-cols-3 md:gap-6">
                                    <div class="md:col-span-1">
                                        <div class="px-4 sm:px-0">
                                            <h3 class="text-lg font-medium leading-6 text-gray-900">Create File</h3>
                                            ...
                                            <div class="px-4 py-5 bg-white sm:p-6">
                                                <div class="grid grid-cols-6 gap-6">
                                                    <div class="col-span-2">
                                                        ...
                                                        <div class="flex border border-gray-300  mt-1  block w-full shadow-sm sm:text-sm  rounded-md px-4 py-2">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" name="file_type" id="file_type_1" value="new" @if(old('file_type')=='new' || !old('file_type')) checked @endif>
                                                                <label class="form-check-label inline-block text-gray-800" for="inlineRadio10">New</label>
                                                            </div>
                                                            <div class="form-check form-check-inline ml-4">
                                                                <input class="form-check-input form-check-input appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="radio" name="file_type" id="file_type_2" value="copy" @if(old('file_type')=='copy') checked @endif>
                                                                <label class="form-check-label inline-block text-gray-800" for="inlineRadio20">Copy</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-span-4">
                                                        <div class="new_file redfield">
                                                        ...
                                                        <div class="hidden copy_file redfield">
                                                            <label for="title" class="block text-sm font-medium text-gray-700">Scan QR</label>
                                                            <input type="password" name="tracking_code" id="tracking_code" value="{{old('tracking_code')}}" autocomplete="tracking_code" class="border-gray-300 @error('tracking_code') border-red-500 @enderror mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm  rounded-md">
                                                            @error('tracking_code')<span class="text-red-500 mt-1 text-sm">{{ $message }}</span>@enderror
                                                        </div>
                                                    </div>
                                                    <div class="col-span-2">
                                                    ...
                                                    <div class="col-span-4">
                                                        <label for="send_to" class="block text-sm font-medium text-gray-700">Sent To</label>

            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex justify-start items-center">
                        <img src="{{url('img/fts_logo.png')}}" class="block h-12 w-auto" title="{{config('app.name')}}">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if(\Illuminate\Support\Facades\Auth::user()->hasRole(['Administrator','DepartmentAdmin']))
                    ...
                    @endcan
                    @if(\Illuminate\Support\Facades\Auth::user()->hasRole('DepartmentAdmin'))

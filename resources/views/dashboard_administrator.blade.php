    ...
    <div class="pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <a href="{{ URL::to('file?status=Under+Process') }}" class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-4 intro-y bg-white">
                    <div class="p-5">
                        <div class="grid grid-cols-3 gap-1">
                            <div class="col-span-2">
                                <div class="text-3xl font-bold leading-8">{{number_format($totalFilesUnderProcess,0)}}</div>

                                <div class="mt-1 text-base  font-bold text-gray-600">Under Process</div>
                            </div>
                            <div class="col-span-1 flex items-center justify-end">
                    ...
                    <div class="p-5">
                        <div class="grid grid-cols-3 gap-1">
                            <div class="col-span-2">
                                ...
                                <div class="mt-1 text-base  font-bold text-gray-600">Closed</div>
                            </div>
                            <div class="col-span-1 flex items-center justify-end">
                ...
                <a href="{{ URL::to('file?status=Under+Process&indep=intransit') }}" class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white">
                    <div class="p-5">
                        <div class="grid grid-cols-3 gap-1">
                            <div class="col-span-2">
                ...
                <a href="{{ URL::to('file?status=Delayed') }}" class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white">
                    <div class="p-5">
                        <div class="grid grid-cols-3 gap-1">
                            <div class="col-span-2">
                                <div class="text-3xl font-bold leading-8">{{number_format($totalFilesDelayed,0)}}</div>

                                <div class="mt-1 text-base  font-bold text-gray-600">Overdue / Delayed</div>
                            </div>
                            <div class="col-span-1 flex items-center justify-end">
                ...
                <a href="{{ URL::to('file?status=Objection') }}" class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white">
                    <div class="p-5">
                        <div class="grid grid-cols-3 gap-1">
                            <div class="col-span-2">
                ...
                <a href="{{ URL::to('file?status=Speak') }}" class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white">
                    <div class="p-5">
                        <div class="grid grid-cols-3 gap-1">
                            <div class="col-span-2">
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                @foreach($Depfiles as $depFiles)
                    <a href="{{ URL::to('depfilesd?dep='.$depFiles[0]->department_id) }}" class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-4 intro-y bg-white">
                        <div class="p-5">
                            <div class="grid grid-cols-3 gap-1">
                                <div class="col-span-2">
                                ...
                                <div class="col-span-1 flex items-center justify-end">
                                    @if(!empty($depFiles[0]->department->logo_path))

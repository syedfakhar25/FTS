<x-app-layout>
    <style>.dt-buttons{float: right!important;}</style>
    <x-slot name="header">
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ URL::to('reports/dispatch') }}" method="get" class="flex flex-wrap mb-4 md:flex-row rounded-lg overflow-hidden">
                ...
                <select name="status" class=" pr-8 border-l border-r border-gray-100 border-t-0 border-b-0  text-gray-700 placeholder-gray-400 bg-white appearance-none dark:text-gray-200 focus:outline-none focus:border-gray-100 focus:ring-0 w-32">
            ...
            @if(count($filesDetails)>0)
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg  clear-both">
                    <table class="min-w-max w-full table-auto datatable-export">
                        ...
                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            ...
                            <th class="p-3 text-left">Sent To</th>
                ...
                buttons: [
                    {
                        ...
                        filename:  "Dispatch Report {{(request()->has('date_range') && !empty(request()->get('date_range'))) ? str_replace('/','-',str_replace('–','to',request()->get('date_range'))):'Overall' }}",
